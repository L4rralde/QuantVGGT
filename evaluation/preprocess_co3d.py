...
def get_parser():
    ...
    parser.add_argument("--output_dir", type=str, default="/data2/fwl/datasets/co3d_v2_annotations/")
    parser.add_argument("--co3d_v2_dir", type=str, default="/data1/3d_datasets/")
    parser.add_argument(
        "--min_quality",
        type=float,
        default=0.5,
